...
type InterviewMode = "technical" | "behavioral" | "hr" | "custom" | "ai-voice";
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {interviewState === "setup" && (
            <div className="max-w-4xl mx-auto space-y-8">
              {/* AI Voice Interview Option */}
              <Card className="glass-card border-2 border-neon-cyan">
                <CardHeader>
                  <CardTitle className="text-neon-cyan font-orbitron flex items-center">
                    <Phone className="h-6 w-6 mr-2" />
                    🎤 AI Voice Interview (NEW!)
                  </CardTitle>
                  <CardDescription>
                    Real-time voice conversation with AI interviewer - Most realistic practice
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <AIInterviewer
                    ...
                    onFinish={(transcript) => {
                      ...
                      toast({
                        ...
                        description: "Your responses have been recorded and saved.",
                      });
                    }}
                  />
                </CardContent>
